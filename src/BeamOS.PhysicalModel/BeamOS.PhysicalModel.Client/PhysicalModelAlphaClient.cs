...
namespace BeamOS.PhysicalModel.Client
{
    ...
    public partial interface IPhysicalModelAlphaClient
    {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Element1DResponse>> GetApiElement1DsAsync(string modelId, System.Collections.Generic.IEnumerable<string> element1dIds, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class PhysicalModelAlphaClient : IPhysicalModelAlphaClient
    {
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Element1DResponse>> GetApiElement1DsAsync(string modelId, System.Collections.Generic.IEnumerable<string> element1dIds)
        {
            return GetApiElement1DsAsync(modelId, element1dIds, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<Element1DResponse>> GetApiElement1DsAsync(string modelId, System.Collections.Generic.IEnumerable<string> element1dIds, System.Threading.CancellationToken cancellationToken)
        {
            if (modelId == null)
