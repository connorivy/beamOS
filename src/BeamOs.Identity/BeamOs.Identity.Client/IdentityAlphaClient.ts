...
export interface IIdentityAlphaClient {
     ...
     * @return Success
     */
    ping(string: string): Promise<string>;

    /**
     * @return Success
     */
    loginWithGoogleEndpoint(returnUrl: string | null, provider: string | null, __RequestVerificationToken: string | null): Promise<void>;
}
