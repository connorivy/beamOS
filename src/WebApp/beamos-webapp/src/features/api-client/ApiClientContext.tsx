...
export const ApiClientContext = createContext<ApiClientType | undefined>(
  undefined,
)
export const IdentityApiClientContext = createContext<
  IdentityApiClientType | undefined
>(undefined)

// Provider component
export function ApiClientProvider({ children }: { children: ReactNode }) {
  const backendUrl = import.meta.env.VITE_STRUCTURALBACKEND_URL as
    | string
    | undefined
...
export function useIdentityApiClient() {
  ...
  if (!context) {
    throw new Error(
      "useIdentityApiClient must be used within an IdentityApiClientProvider",
    )
  }
  return context
}
