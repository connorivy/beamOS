...
//             "DeleteAllResultSetsAsync is not implemented in the in-memory client."
//         );
...
//     public Task<Result<Element1dResponse>> GetElement1dAsync(
//         Guid modelId,
//         int id,
//         CancellationToken cancellationToken = default
//     ) => throw new NotImplementedException();

//     public Task<Result<LoadCase>> GetLoadCaseAsync(
//         Guid modelId,
//         int id,
//         CancellationToken cancellationToken = default
//     ) => throw new NotImplementedException();

//     public Task<Result<LoadCombination>> GetLoadCombinationAsync(
//         Guid modelId,
//         int id,
//         CancellationToken cancellationToken = default
//     ) => throw new NotImplementedException();

//     public async Task<Result<ModelResponse>> GetModelAsync(
//         Guid modelId,
//         CancellationToken cancellationToken = default
//     ) => await inMemoryGetModelCommandHandler.ExecuteAsync(modelId, cancellationToken);

//     public Task<Result<ModelProposalResponse>> GetModelProposalAsync(
//         Guid modelId,
//         int id,
//         CancellationToken cancellationToken = default
//     ) => throw new NotImplementedException();

//     public Task<Result<List<ModelProposalInfo>>> GetModelProposalsAsync(
//         Guid modelId,
//         CancellationToken cancellationToken = default
//     ) => throw new NotImplementedException();

//     public Task<Result<List<ModelInfoResponse>>> GetModelsAsync(
//         CancellationToken cancellationToken = default
//     ) => throw new NotImplementedException();
...
//     ) =>
//         throw new NotImplementedException(
//             "GetNodeResultAsync is not implemented in the in-memory client."
//         );

//     public Task<Result<ResultSetResponse>> GetResultSetAsync(
//         Guid modelId,
//         int id,
//         CancellationToken cancellationToken = default
//     ) => throw new NotImplementedException();

//     public Task<Result<GithubModelsChatResponse>> GithubModelsChatAsync(
//         Guid modelId,
//         GithubModelsChatRequest body,
//         CancellationToken cancellationToken = default
//     ) => throw new NotImplementedException();
...
//     public Task<Result<ModelResponse>> PutModelAsync(
//         Guid modelId,
//         ModelInfoData body = null,
//         CancellationToken cancellationToken = default
//     ) => throw new NotImplementedException();
...
//     ) =>
//         throw new NotImplementedException(
//             "RejectModelProposalAsync is not implemented in the in-memory client."
//         );
...
//     ) =>
//         throw new NotImplementedException(
//             "RunDirectStiffnessMethodAsync is not implemented in the in-memory client."
//         );
...
//     ) =>
//         throw new NotImplementedException(
//             "RunOpenSeesAnalysisAsync is not implemented in the in-memory client."
//         );
...
//     ) =>
//         throw new NotImplementedException(
//             "SpeckleRecieveOperationAsync is not implemented in the in-memory client."
//         );
...
//     ) =>
//         throw new NotImplementedException(
//             "UpdateNodeAsync is not implemented in the in-memory client."
//         );
