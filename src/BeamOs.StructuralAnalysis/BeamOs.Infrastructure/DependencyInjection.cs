...
using BeamOs.Infrastructure.Repositories.AnalyticalModel.Diagrams.ShearDiagrams;
using BeamOs.Infrastructure.Repositories.AnalyticalModel.ModelResults;
using BeamOs.Infrastructure.Repositories.AnalyticalModel.NodeResults;
