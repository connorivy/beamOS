...
public static class VectorExtensions
{
    ...
    public static void AssertAlmostEqual(
        this Vector<double> calculatedVector,
    ...
    )
    {
        ...
        Assert.False(
            ...
            VectorUnequalExceptionMessage(calculated, expected)
        );
    }

    public static string VectorUnequalExceptionMessage(
        Vector<double> calculatedVector,
        Vector<double> expectedVector
    )
    {
