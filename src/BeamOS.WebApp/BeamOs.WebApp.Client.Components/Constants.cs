...
public static class Constants
{
    ...
    public const string STRUCTURAL_ANALYSIS_METER_NAME = "BeamOs.Api";
    ...
    public const string EDITOR_USE_SERVED_CONFIG_NAME = "Editor:UseServed";
    public const string EDITOR_PORT_CONFIG_NAME = "Editor:Port";
}
