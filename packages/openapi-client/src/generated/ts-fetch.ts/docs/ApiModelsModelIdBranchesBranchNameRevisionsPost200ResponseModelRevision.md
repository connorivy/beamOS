...
# ApiModelsModelIdBranchesBranchNameRevisionsPost200ResponseModelRevision
...
------------ | -------------
`id` | string
`version` | [ApiModelsModelIdBranchesBranchNameRevisionsPost200ResponseModelRevisionVersion](ApiModelsModelIdBranchesBranchNameRevisionsPost200ResponseModelRevisionVersion.md)
`modelId` | string
`name` | string
...
```typescript
import type { ApiModelsModelIdBranchesBranchNameRevisionsPost200ResponseModelRevision } from ''
...
const example = {
  ...
  "element1ds": null,
} satisfies ApiModelsModelIdBranchesBranchNameRevisionsPost200ResponseModelRevision
...
const exampleParsed = JSON.parse(exampleJSON) as ApiModelsModelIdBranchesBranchNameRevisionsPost200ResponseModelRevision
