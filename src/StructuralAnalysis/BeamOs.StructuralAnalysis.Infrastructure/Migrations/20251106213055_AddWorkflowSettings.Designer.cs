...
namespace BeamOs.StructuralAnalysis.Infrastructure.Migrations
{
    ...
    [Migration("20251106213055_AddWorkflowSettings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeamOs.StructuralAnalysis.Domain.PhysicalModel.ModelAggregate.DeleteModelEntityProposal", b =>
                {
                    ...
                    b.HasKey("Id", "ObjectType", "ModelProposalId", "ModelId");
            ...
            modelBuilder.Entity("BeamOs.StructuralAnalysis.Domain.PhysicalModel.ModelAggregate.Model", b =>
                {
                    ...
                    b.Property<Guid?>("BimSourceModelId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("MaxElement1dId")
                        .HasColumnType("integer");

                    b.Property<int>("MaxInternalNodeId")
                        .HasColumnType("integer");

                    b.Property<int>("MaxLoadCaseId")
                        .HasColumnType("integer");

                    b.Property<int>("MaxLoadCombinationId")
                        .HasColumnType("integer");

                    b.Property<int>("MaxMaterialId")
                        .HasColumnType("integer");

                    b.Property<int>("MaxModelProposalId")
                        .HasColumnType("integer");

                    b.Property<int>("MaxMomentLoadId")
                        .HasColumnType("integer");

                    b.Property<int>("MaxNodeId")
                        .HasColumnType("integer");

                    b.Property<int>("MaxPointLoadId")
                        .HasColumnType("integer");

                    b.Property<int>("MaxSectionProfileFromLibraryId")
                        .HasColumnType("integer");

                    b.Property<int>("MaxSectionProfileId")
                        .HasColumnType("integer");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Settings", "BeamOs.StructuralAnalysis.Domain.PhysicalModel.ModelAggregate.Model.Settings#ModelSettings", b1 =>
                        {
                            ...
                            b1.ComplexProperty<Dictionary<string, object>>("WorkflowSettings", "BeamOs.StructuralAnalysis.Domain.PhysicalModel.ModelAggregate.Model.Settings#ModelSettings.WorkflowSettings#WorkflowSettings", b2 =>
                                {
                                    b2.IsRequired();

                                    b2.Property<string>("BimFirstModelIdsSerialized")
                                        .HasColumnType("text");

                                    b2.Property<byte>("ModelingMode")
                                        .HasColumnType("smallint");
                                });
                        });
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Settings", "BeamOs.StructuralAnalysis.Domain.PhysicalModel.ModelAggregate.ModelProposal.Settings#ModelSettings", b1 =>
                        {
                            ...
                            b1.ComplexProperty<Dictionary<string, object>>("WorkflowSettings", "BeamOs.StructuralAnalysis.Domain.PhysicalModel.ModelAggregate.ModelProposal.Settings#ModelSettings.WorkflowSettings#WorkflowSettings", b2 =>
                                {
                                    b2.IsRequired();
            ...
            modelBuilder.Entity("BeamOs.StructuralAnalysis.Domain.PhysicalModel.ModelAggregate.Model", b =>
                {
                    b.HasOne("BeamOs.StructuralAnalysis.Domain.PhysicalModel.ModelAggregate.Model", "BimSourceModel")
                        .WithMany()
                        .HasForeignKey("BimSourceModelId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("BimSourceModel");
                });
