...
export interface IApiAlphaClient {
     ...
     * @return Success
     */
    runOpenSeesAnalysis(modelId: string, body: any | undefined): Promise<boolean>;

    /**
     * @param body (optional) 
     * @return Success
     */
    runDirectStiffnessMethod(modelId: string, body: any | undefined): Promise<boolean>;
     ...
     * @return Success
     */
    getModelResults(modelId: string): Promise<AnalyticalResultsResponse>;
...
export class AnalyticalResultsResponse extends BeamOsContractBase implements IAnalyticalResultsResponse {
    modelId!: string;
...
export interface IAnalyticalResultsResponse extends IBeamOsContractBase {
    modelId: string;
    maxShear: ForceContract;
    minShear: ForceContract;
    maxMoment: TorqueContract;
...
export class ModelResponse extends BeamOsEntityContractBase implements IModelResponse {
    ...
    analyticalResults?: AnalyticalResultsResponse | undefined;
    ...
    init(_data?: any) {
        ...
        if (_data) {
            ...
            this.analyticalResults = _data["analyticalResults"] ? AnalyticalResultsResponse.fromJS(_data["analyticalResults"]) : <any>undefined;
        }
    }
