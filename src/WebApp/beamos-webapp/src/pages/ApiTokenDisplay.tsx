        ...
        <Box>
                                ...
                                <TableRow key={token.name}>
                                    ...
                                    <Dialog open={deleteIdx !== null} onClose={handleDeleteCancel}>
                                        ...
                                        <DialogActions>
                                            ...
                                            <Button color="error" variant="contained" onClick={() => { void handleDeleteConfirm(); }} autoFocus>
                                                Delete
                                            </Button>
                                        </DialogActions>
                                    </Dialog>
            ...
            <Dialog open={createDialogOpen} onClose={handleDialogClose}>
                ...
                <DialogActions>
                    ...
                    {!showToken && (
                        <Button variant="contained" onClick={() => { void handleCreate(); }} disabled={!newName || newScopes.length === 0}>
                            Create
                        </Button>
                    )}
                </DialogActions>
