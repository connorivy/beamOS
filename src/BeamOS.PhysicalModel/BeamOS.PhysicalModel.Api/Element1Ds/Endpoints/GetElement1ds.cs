...
public class GetElement1ds2(
    PhysicalModelDbContext dbContext,
    Element1DResponseMapper responseMapper
) : BeamOsFastEndpoint<string, List<Element1DResponse>>
{
    public override void Configure()
    {
        ...
        Summary(s =>
        {
            s.Params["element1dIds"] = "list of element1ds to retrieve. Leave blank to retrieve";
        });
    }
    ...
    )
    {
        ...
        string[]? element1dIds = this.Query<string[]>("element1dIds");
