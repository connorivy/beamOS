...
namespace BeamOS.DirectStiffnessMethod.Domain.Element1DAggregate;
public class Element1D : AggregateRoot<Element1DId>
{
    ...
    public static Element1D Create(
        ...
        SectionProfile sectionProfile)
    {
        return new(Element1DId.CreateUnique(), sectionProfileRotation, unitSettings, startNode, endNode, material, sectionProfile);
    }
