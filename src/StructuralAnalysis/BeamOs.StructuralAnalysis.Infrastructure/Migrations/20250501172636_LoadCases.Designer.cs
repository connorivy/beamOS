...
namespace BeamOs.StructuralAnalysis.Infrastructure.Migrations
{
    ...
    [Migration("20250501172636_LoadCases")]
    partial class LoadCases
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeamOs.StructuralAnalysis.Domain.AnalyticalResults.ResultSetAggregate.ResultSet", b =>
                {
                    ...
                    b.Property<int?>("LoadCombinationId1")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("LoadCombinationId1", "LoadCombinationModelId");
            ...
            modelBuilder.Entity("BeamOs.StructuralAnalysis.Domain.PhysicalModel.LoadCombinationAggregate.LoadCombination", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("BeamOs.StructuralAnalysis.Domain.AnalyticalResults.ResultSetAggregate.ResultSet", b =>
                {
                    ...
                    b.HasOne("BeamOs.StructuralAnalysis.Domain.PhysicalModel.LoadCombinationAggregate.LoadCombination", "LoadCombination")
                        .WithMany()
                        .HasForeignKey("LoadCombinationId1", "LoadCombinationModelId");
            ...
            modelBuilder.Entity("BeamOs.StructuralAnalysis.Domain.PhysicalModel.Element1dAggregate.Element1d", b =>
                {
                    ...
                    b.HasOne("BeamOs.StructuralAnalysis.Domain.PhysicalModel.SectionProfileAggregate.SectionProfile", "SectionProfile")
                        .WithMany()
