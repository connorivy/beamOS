        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CustomData_Data = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ModelResultId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NodeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomData_Data = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MomentForceDiagramId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ShearForceDiagramId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomData_Data = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    StartLocation = table.Column<double>(type: "float", nullable: false),
                    EndLocation = table.Column<double>(type: "float", nullable: false),
                    Polynomial = table.Column<string>(type: "nvarchar(max)", nullable: false),
