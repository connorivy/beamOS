...
namespace BeamOs.ApiClient
{
    ...
    public partial interface IApiAlphaClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ModelResponse> GetModelAsync(string @string, string id);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<ModelResponse> GetModelAsync(string @string, string id, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class ApiAlphaClient : IApiAlphaClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<ModelResponse> GetModelAsync(string @string, string id)
        {
            return GetModelAsync(@string, id, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<ModelResponse> GetModelAsync(string @string, string id, System.Threading.CancellationToken cancellationToken)
        {
            if (@string == null)
