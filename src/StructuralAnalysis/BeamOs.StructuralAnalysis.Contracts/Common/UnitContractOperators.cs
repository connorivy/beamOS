...
public static class UnitContractOperators
{
    ...
    )
    {
        ...
        {
            ForceUnitContract.Kilonewton => lengthUnitContract switch
            {
            ...
            ForceUnitContract.KilopoundForce => lengthUnitContract switch
            {
            ...
            ForceUnitContract.Newton => lengthUnitContract switch
            {
            ...
            ForceUnitContract.PoundForce => lengthUnitContract switch
            {
