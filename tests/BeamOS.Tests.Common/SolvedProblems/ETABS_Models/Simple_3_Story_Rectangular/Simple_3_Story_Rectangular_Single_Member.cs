...
public class Simple_3_Story_Rectangular_Single_Member
    : CreateModelRequestBuilder,
        IHasExpectedNodeDisplacementResults
{
    public override Guid ModelGuid { get; } = Guid.Parse("a71a50bb-0504-45b5-befb-c32146b4f6dc");
    ...
    private int[] yValues = [0];
    private int[] zValues = [0];

    private Simple_3_Story_Rectangular_Single_Member()
    {
    ...
    private void CreateNodes()
    {
        for (int xIndex = 0; xIndex < this.xValues.Length; xIndex++)
        {
            for (int yIndex = 0; yIndex < this.yValues.Length; yIndex++)
            {
                ...
                {
                    RestraintRequest restraint = RestraintRequest.Free;
                    //if (xIndex == 0)
                    //{
                    ...
                    //else
                    //{
                    //    restraint = RestraintRequest.Fixed with { CanTranslateAlongY = true };
                    //}
    ...
    public static Simple_3_Story_Rectangular_Single_Member Instance { get; } = new();
}
