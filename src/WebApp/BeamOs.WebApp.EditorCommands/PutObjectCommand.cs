...
public abstract record PutObjectCommand<TObject>(TObject? Previous, TObject? New) : IBeamOsClientCommand
{
...
public record PutNodeEditorCommand(NodeResponse Previous, NodeResponse New) : PutObjectCommand<NodeResponse>(Previous, New);
