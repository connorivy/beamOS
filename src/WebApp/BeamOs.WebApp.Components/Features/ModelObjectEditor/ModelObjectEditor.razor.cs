...
[FeatureState]
public record ModelObjectEditorState(
    BeamOsObjectType CurrentViewType,
    SelectedObject? SelectedObject
)
{
    public ModelObjectEditorState()
        : this(BeamOsObjectType.Model, null) { }
}

public static class Reducers
{
    [ReducerMethod]
    public static ModelObjectEditorState Reducer(
        ModelObjectEditorState state,
