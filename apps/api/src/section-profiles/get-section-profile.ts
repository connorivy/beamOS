...
export const getSectionProfile = defineEndpoint({
    method: "GET",
    path: "/api/projects/:projectId/branches/:branchName/section-profiles/:sectionProfileId",
    ...
    async handler(req, ctx: AppContext) {
        ...
        const sectionProfile = modelRevision?.getSectionProfileById(req.params.sectionProfileId);
